...
public class BillingServiceImplement implements BillingService
{
    ...
    @Override
    public List<BillingDetails> getBillingByUserId(String userId) {
        return billingRepository.findByUserId(userId);
    }

    @Override
    public List<BillingDetails> getBillingByClaimsId(String claimsId) {
        return billingRepository.findByClaimsId(claimsId);
    }
}
